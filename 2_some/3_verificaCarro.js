/* 
  ...
  Usando some():
    1. Crie uma função chamada verificaCarro;
    2. Essa função recebe um array de strings como parâmetro;
    3. A função então retorna:
      a. Se o carro "Uno" estiver na lista: 'O melhor carro de todos está na lista'
      b. Se o carro "Uno" não estiver na lista: 'O melhor carro de todos NÃO está lista'
